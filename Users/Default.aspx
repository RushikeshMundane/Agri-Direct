				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
                        ...
                        <li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="View_Shop.aspx">View Shop</a>
						</li>
                         <li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="All_products.aspx">View Products</a>
						</li>
						
						<li class="nav-item">
							<a class="nav-link" href="My_orders.aspx">My order</a>
						</li>
                        <li class="nav-item">
							<a class="nav-link" href="Trasactions.aspx">My Trasaction</a>
						</li>
					</ul>
				</div>
			</nav>
