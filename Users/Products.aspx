<%@ Page Title="" Language="C#" MasterPageFile="~/Users/MasterPage.master" AutoEventWireup="true" CodeFile="Products.aspx.cs" Inherits="Users_Products" %>
      ...
      <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								...
								<asp:SqlDataSource ID="SqlDataSource_pview" runat="server" 
                                    ...
                                    SelectCommand="SELECT * FROM [Add_Product] WHERE ([shopid] = @shopid)">
                                    <SelectParameters>
                                        <asp:QueryStringParameter Name="shopid" QueryStringField="shopname" 
                                            Type="Int32" />
                                    </SelectParameters>
