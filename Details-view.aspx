     ...
     <asp:Repeater ID="Repeater1" runat="server" 
		...
		<div class="container py-xl-4 py-lg-2">
                    	...
                    	<ul class="slides">
							<li data-thumb="photos/<%#Eval("photo") %>">
								...
								<div class="thumb-image">
									<img src="photos/<%#Eval("photo") %>"  data-imagezoom="true" class="img-responsive" alt="" height="200px" width="200px"> </div>
							</li>
							<%--<li data-thumb="photos/<%#Eval("photo") %>" >
								<div class="thumb-image">
			...
			<%--		<div class="single-infoagile">
                    ...
                    <a href="Add-cart.aspx?pid=<%#Eval("pid") %>" class="btn btn-primary">Add to cart</a>
